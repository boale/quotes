...
import { generateUniqueId, getFormattedTagsFromFormValue, getTagsArrayFromTagsData } from './quote-tag.models-rules';
...
export class QuoteTagComponent implements OnInit {
  @Input() initialData: string | string[];
  ...
  ngOnInit(): void {
    this.tags = getTagsArrayFromTagsData(this.initialData);
